...
### Payloads
  ...
  * Request: None
  * Response: [Cash Advances Response](#cash-advances-response-schema) 
...
### Payloads
  ...
  * Request: [Cash Advance Associations Post](#cash-advances-post-schema) 
  * Response: [Cash Advance Associations URI](#cash-advance-uri-schema)
...
### <a name="cash-advances-response-schema"></a> Cash Advances Get Response

| Name         | Type   | Format | Description                                      |
|--------------|--------|--------|--------------------------------------------------|
| cashAdvances | array  | [Cash Advance Response](#cash-advance-response-schema) | List of the associated cash advance objects.     |

#### <a name="cash-advances-post-schema"></a> Cash Advances Response

| Name         | Type   | Format | Description                                      |
|--------------|--------|--------|--------------------------------------------------|
| cashAdvanceIds | array  | uuid    | List of the associated cash advance ids     |

### <a name="cash-advance-uri-schema"></a> Cash Advance Response URI Response
